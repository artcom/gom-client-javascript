...
/*globals Logger Buffer module*/

// Browser fallback for use

if (!("use" in this)) {
    this.use = function () {
        // NOOP
        Logger.trace("use for '" + arguments[0] + "' called");
    };
}

// Browser compatible createUniqueId (also works in node.js)
if (!("createUniqueId" in this)) {
    // --uuid.js
    (function () {
        /*
        ...
        */
        ...
        if (typeof(module) !== 'undefined') {
            ...
            this.createUniqueId = uuid; // Y60 compatible
        }
    }());
}